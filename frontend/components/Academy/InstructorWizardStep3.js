...
class InstructorWizardStep3 extends React.Component {
                ...
                <div className="wizard-content">
                    <div className="row">
                        <div className="col-md-6 offset-md-3 text-center">
                            <h1 style={HeadingStyle}>PLEASE PROVIDE SOME BASIC INFORMATION OF THE PROJECT</h1>
                            <FormGroup>
                                <div className="row">
...
export default InstructorWizardStep3;