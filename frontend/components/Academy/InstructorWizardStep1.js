...
class InstructorWizardStep1 extends React.Component {
                ...
                <div className="wizard-content">
                    <div className="row">
                        <div className="col-md-6 offset-md-3 text-center">
                            <h1 style={HeadingStyle}>PLEASE PROVIDE SOME BASIC INFORMATION AS INSTRUCTOR</h1>
                            <FormGroup>
                                <div className="row">
...
export default InstructorWizardStep1;