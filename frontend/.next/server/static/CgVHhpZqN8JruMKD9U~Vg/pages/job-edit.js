...
/*#__PURE__*/
function (_React$Component) {
  _inherits(JobEdit, _React$Component);

  function JobEdit() {
    _classCallCheck(this, JobEdit);

    return _possibleConstructorReturn(this, _getPrototypeOf(JobEdit).apply(this, arguments));
  }

  _createClass(JobEdit, [{
    key: "render",
    value: function render() {
...
/* harmony default export */ __webpack_exports__["default"] = (JobEdit);
