...
/* harmony default export */ var People_PeopleWizard = __webpack_exports__["a"] = (Object(styles_["withStyles"])(styles)(PeopleWizard_PeopleWizard));
...
/* harmony import */ var _components_People_PeopleWizard_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(60);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(PeopleSeup, _React$Component);

  function PeopleSeup() {
    _classCallCheck(this, PeopleSeup);

    return _possibleConstructorReturn(this, _getPrototypeOf(PeopleSeup).apply(this, arguments));
  }

  _createClass(PeopleSeup, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_People_PeopleWizard_index__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], null));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (PeopleSeup);
