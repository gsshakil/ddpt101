...
function getStepContent(stepIndex) {
  switch (stepIndex) {
    case 0:
      return external_react_default.a.createElement(Products_ProductWizardStep1, null);

    case 1:
      return external_react_default.a.createElement(Products_ProductWizardStep2, null);

    case 2:
      return external_react_default.a.createElement(Products_ProductWizardStep3, null);
...
function (_React$Component) {
  ...
  function ProductEdit() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ProductEdit).apply(this, arguments));
  }
