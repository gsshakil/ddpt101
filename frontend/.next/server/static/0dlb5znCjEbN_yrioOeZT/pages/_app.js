...
function (_React$Component) {
  ...
  Header_createClass(Header, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          onToggleCollapsedNav = _this$props.onToggleCollapsedNav,
          drawerType = _this$props.drawerType; // const drawerStyle = drawerType.includes(FIXED_DRAWER) ? "d-block d-xl-none" : drawerType.includes(COLLAPSED_DRAWER) ? "d-block" : "d-none";
      ...
      return external_react_default.a.createElement(AppBar_default.a, {
        ...
        className: "jr-menu-icon ".concat(drawerStyle),
        "aria-label": "Menu",
