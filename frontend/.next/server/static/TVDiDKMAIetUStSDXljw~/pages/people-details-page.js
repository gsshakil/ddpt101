...
;
/* harmony default export */ var Projects_ProjectCard = (ProjectCard_ProjectCard);
// CONCATENATED MODULE: ./components/Products/ProductDetails.js
function ProductDetails_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { ProductDetails_typeof = function _typeof(obj) { return typeof obj; }; } else { ProductDetails_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return ProductDetails_typeof(obj); }
...
function ProductDetails_possibleConstructorReturn(self, call) { if (call && (ProductDetails_typeof(call) === "object" || typeof call === "function")) { return call; } return ProductDetails_assertThisInitialized(self); }

function ProductDetails_getPrototypeOf(o) { ProductDetails_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return ProductDetails_getPrototypeOf(o); }

function ProductDetails_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function ProductDetails_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) ProductDetails_setPrototypeOf(subClass, superClass); }

function ProductDetails_setPrototypeOf(o, p) { ProductDetails_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return ProductDetails_setPrototypeOf(o, p); }
...
/*#__PURE__*/
function (_React$Component) {
  ProductDetails_inherits(ProductDetails, _React$Component);
  ...
  function ProductDetails(props) {
    ...
    _this = ProductDetails_possibleConstructorReturn(this, ProductDetails_getPrototypeOf(ProductDetails).call(this, props));
    _this.toggle = _this.toggle.bind(ProductDetails_assertThisInitialized(_this));
    _this.state = {
      activeTab: '1'
    };
    return _this;
  ...
  PeopleDetails_createClass(PeopleDetails, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        ...
        label: "Apps"
      }))), value === 0 && external_react_default.a.createElement(TabContainer, null, external_react_default.a.createElement(external_react_masonry_infinite_default.a, {
        className: "masonry",
        sizes: sizes
      }, external_react_default.a.createElement(Projects_ProjectCard, {
        ...
        dateTime: "August 20, 2019 12:39 PM",
        commentCount: "2555"
      }))), value === 1 && external_react_default.a.createElement(TabContainer, null, external_react_default.a.createElement("div", {
        className: "row"
      }, external_react_default.a.createElement("div", {
        className: "col-md-3 m-b-sm"
