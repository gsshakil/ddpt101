...
/* harmony default export */ var Products_ProductWizard = (Object(styles_["withStyles"])(styles)(ProductWizard_ProductWizard));
// CONCATENATED MODULE: ./pages/product-edit.js
function product_edit_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { product_edit_typeof = function _typeof(obj) { return typeof obj; }; } else { product_edit_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return product_edit_typeof(obj); }

function product_edit_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function product_edit_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function product_edit_createClass(Constructor, protoProps, staticProps) { if (protoProps) product_edit_defineProperties(Constructor.prototype, protoProps); if (staticProps) product_edit_defineProperties(Constructor, staticProps); return Constructor; }

function product_edit_possibleConstructorReturn(self, call) { if (call && (product_edit_typeof(call) === "object" || typeof call === "function")) { return call; } return product_edit_assertThisInitialized(self); }

function product_edit_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function product_edit_getPrototypeOf(o) { product_edit_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return product_edit_getPrototypeOf(o); }

function product_edit_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) product_edit_setPrototypeOf(subClass, superClass); }

function product_edit_setPrototypeOf(o, p) { product_edit_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return product_edit_setPrototypeOf(o, p); }




var product_edit_ProductEdit =
/*#__PURE__*/
function (_React$Component) {
  product_edit_inherits(ProductEdit, _React$Component);

  function ProductEdit() {
    product_edit_classCallCheck(this, ProductEdit);

    return product_edit_possibleConstructorReturn(this, product_edit_getPrototypeOf(ProductEdit).apply(this, arguments));
  }

  product_edit_createClass(ProductEdit, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(Products_ProductWizard, null));
    }
  }]);
...
/* harmony default export */ var product_edit = __webpack_exports__["default"] = (product_edit_ProductEdit);
