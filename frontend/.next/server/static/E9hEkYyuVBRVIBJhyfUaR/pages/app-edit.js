...
function (_React$Component) {
  _inherits(AppEdit, _React$Component);

  function AppEdit() {
    _classCallCheck(this, AppEdit);

    return _possibleConstructorReturn(this, _getPrototypeOf(AppEdit).apply(this, arguments));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (AppEdit);
