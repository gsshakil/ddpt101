...
function (_React$Component) {
  ...
  function Header(props) {
    ...
    _this.toggleSA = _this.toggleSA.bind();
    _this.toggleCart = _this.toggleCart.bind();
    _this.toggleBell = _this.toggleBell.bind();
    _this.toggleInbox = _this.toggleInbox.bind();
    _this.state = {
